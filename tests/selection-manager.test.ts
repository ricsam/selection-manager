...
describe("SelectionManager", () => {
  ...
  describe("Basic Selection", () => {
    ...
    it("should select a single cell", () => {
      selectionManager.cellMouseDown(2, 3, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseUp(2, 3);
    ...
    it("should select a range by dragging", () => {
      selectionManager.cellMouseDown(1, 1, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseEnter(3, 4);
      selectionManager.cellMouseUp(3, 4);
  ...
  describe("Multi-Selection", () => {
    it("should add selections with Ctrl+click", () => {
      // First selection
      selectionManager.cellMouseDown(1, 1, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseUp(1, 1);

      // Second selection with Ctrl
      selectionManager.cellMouseDown(3, 3, { shiftKey: false, ctrlKey: true, metaKey: false });
      selectionManager.cellMouseUp(3, 3);
    ...
    it("should remove selections with Ctrl+click on selected cell", () => {
      ...
      selectionManager.cellMouseUp(2, 2);

      expect(selectionManager.isSelected({ row: 1, col: 1 })).toBe(true);
      expect(selectionManager.isSelected({ row: 2, col: 2 })).toBe(true);

      // Remove part of the selection with Ctrl+click
      selectionManager.cellMouseDown(1, 1, { shiftKey: false, ctrlKey: true, metaKey: false });
      selectionManager.cellMouseUp(1, 1);
    ...
    it("should extend selection with Shift+click", () => {
      // First selection
      selectionManager.cellMouseDown(2, 2, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseUp(2, 2);

      // Extend with Shift+click
      selectionManager.cellMouseDown(4, 4, { shiftKey: true, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseUp(4, 4);
  ...
  describe("Header Selection", () => {
    it("should select entire row when clicking row header", () => {
      selectionManager.headerMouseDown(2, 'row', { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.headerMouseUp(2, 'row');
    ...
    it("should select entire column when clicking column header", () => {
      selectionManager.headerMouseDown(3, 'col', { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.headerMouseUp(3, 'col');
    ...
    it("should select multiple rows with Ctrl+click on headers", () => {
      // Select first row
      selectionManager.headerMouseDown(1, 'row', { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.headerMouseUp(1, 'row');

      // Add another row with Ctrl
      selectionManager.headerMouseDown(3, 'row', { shiftKey: false, ctrlKey: true, metaKey: false });
      selectionManager.headerMouseUp(3, 'row');
    ...
    it("should remove row selection with Ctrl+click on selected row header", () => {
      ...
      selectionManager.headerMouseDown(2, 'row', { shiftKey: false, ctrlKey: true, metaKey: false });
      selectionManager.headerMouseUp(2, 'row');
  ...
  describe("Selection Queries", () => {
    ...
    it("should provide selection borders", () => {
      ...
      const centerBorders = selectionManager.selectionBorders({ row: 2, col: 2 });
      expect(centerBorders).toEqual([]);

      const bottomRightBorders = selectionManager.selectionBorders({ row: 3, col: 3 });
  ...
  describe("Infinite Grid Support", () => {
    ...
    it("should handle infinite dimensions in row selection", () => {
      infiniteSelectionManager.headerMouseDown(2, 'row', { shiftKey: false, ctrlKey: false, metaKey: false });
      infiniteSelectionManager.headerMouseUp(2, 'row');
    ...
    it("should handle infinite dimensions in column selection", () => {
      infiniteSelectionManager.headerMouseDown(3, 'col', { shiftKey: false, ctrlKey: false, metaKey: false });
      infiniteSelectionManager.headerMouseUp(3, 'col');
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle arrow navigation at boundaries", () => {
      // Start at top-left
      selectionManager.cellMouseDown(0, 0, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseUp(0, 0);
  ...
  describe("Union of Selections for Whole Row/Column", () => {
    it("should detect whole row selected from union of multiple selections", () => {
      ...
      selectionManager.cellMouseDown(2, 0, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseEnter(2, 2);
      selectionManager.cellMouseUp(2, 2);

      // Add right part of row 2 (cols 3-4) with Ctrl
      selectionManager.cellMouseDown(2, 3, { shiftKey: false, ctrlKey: true, metaKey: false });
      selectionManager.cellMouseEnter(2, 4);
      selectionManager.cellMouseUp(2, 4);
    ...
    it("should detect whole column selected from union of multiple selections", () => {
      ...
      selectionManager.cellMouseDown(0, 3, { shiftKey: false, ctrlKey: false, metaKey: false });
      selectionManager.cellMouseEnter(4, 3);
      selectionManager.cellMouseUp(4, 3);

      // Add bottom part of column 3 (rows 5-9) with Ctrl
      selectionManager.cellMouseDown(5, 3, { shiftKey: false, ctrlKey: true, metaKey: false });
      selectionManager.cellMouseEnter(9, 3);
      selectionManager.cellMouseUp(9, 3);
    ...
    it("should not detect whole row if union has gaps", () => {
      ...
      selectionManager.cellMouseUp(2, 1);
